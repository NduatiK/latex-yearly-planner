...
3. From the project directory, run the following command. This should generate the PDF in the 'result' directory.
<code>./release.sh</code> 

[Source](https://github.com/kudrykv/latex-yearly-planner/discussions/34#discussioncomment-3128344)

4. Check the "release" directory for the 'pdf' planner. To move it to your device
